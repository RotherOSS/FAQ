...
sub Data {
    ...
    $Self->{Translation}->{'Agent groups that can access articles in this category.'}
        = 'Ügyintézőcsoportok, amelyek hozzáférnek a bejegyzésekhez ebben a kategóriában.';
    ...
    $Self->{Translation}->{'No votes found! Be the first one to rate this FAQ article.'}
        = 'Nem találhatók szavazatok! Legyen az első, aki értékeli ezt a GyIK bejegyzést.';
    ...
    $Self->{Translation}->{'Type a subject or text to get a list of helpful resources.'}
        = 'Írjon be egy tárgyat vagy szöveget a hasznos erőforrások listájának lekéréséhez.';

    # Template: CustomerFAQSearch
    $Self->{Translation}->{'Fulltext search in FAQ articles (e. g. "John*n" or "Will*")'}
        = 'Szabad-szavas keresés a GyIK bejegyzésekben (például „J*nos” vagy „Kov*”)';
    ...
    $Self->{Translation}->{'No categories found where user has read/write permissions!'}
        = 'Nem találhatók olyan kategóriák, ahol a felhasználónak írási/olvasási jogosultságai vannak!';
    ...
    $Self->{Translation}->{'Default state of tickets for the approval of FAQ articles.'}
        = 'A jegyek alapértelmezett állapota a GyIK bejegyzések jóváhagyásánál.';
    $Self->{Translation}->{'Default type of tickets for the approval of FAQ articles.'}
        = 'A jegyek alapértelmezett típusa a GyIK bejegyzések jóváhagyásánál.';
    ...
    $Self->{Translation}->{'Defines where the \'Insert FAQ\' link will be displayed.'}
        = 'Meghatározza, hogy a „GyIK beszúrása” hivatkozás hol legyen megjelenítve.';
    ...
    $Self->{Translation}->{'Limit for the search to build the keyword FAQ article list.'}
        = 'A keresés korlátozása a kulcsszó GyIK bejegyzéslista összeállításához.';
    ...
    $Self->{Translation}->{'New FAQ articles need approval before they get published.'}
        = 'Az új GyIK bejegyzések jóváhagyása szükséges a közzétételük előtt.';
